        ...
        <div class=" row px-2">
            <div class="col-md-12 col-xl-8">
                <div class="row ">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12  pb-1 pt-2" style="border-bottom:1px solid gray;">
                                    <div class="row">
                                        ...
                                        <div class="col-2 col-sm-2 col-md-2 px-1" style="border-right:1px solid gray;">
                                            <span id="Sunrise" style=" text-transform: capitalize">Sunrise: {{$Sunrise}}</span>
                                            <span id="Sunset" style=" text-transform: capitalize">Sunset:&nbsp; {{$Sunset}}</span>
                                        </div>
                                        <div class="col-2 col-sm-2 col-md-2 px-1">
                                            <span id="Sunrise" style=" text-transform: capitalize">Day:&nbsp; {{$DayLength}}</span>
                                            <span id="Sunset" style=" text-transform: capitalize">Night: {{$NightLength}}</span>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 pb-1 pt-1">
                                    <div class="row">
                                        <div class="col-4 col-sm-4 col-md-4 px-1" style="border-right:1px solid gray;">
                    ...
                    <!-- DONNNNNNNNNNNNNNNNNNNNNNNNNNNNE -->
                    <!-- City Details -->
                    <div class="col-12 col-sm-4 col-md-12 col-lg-6 col-xl-4 px-1 mt-3" style="border-left:1px solid gray;border-right:1px solid gray;">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 mt-0">
                                    <div class="row">
                                        <div class="col-md-12 pb-2 pt-1 px-1 text-center" style="border-bottom:1px solid gray;">
                    ...
                    <!-- Weather -->
                    <div class="col-12 col-sm-4 col-md-12 col-lg-6 col-xl-4 px-1 mt-3 text-left">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 px-1 mt-1 text-right" style="margin-left: -15px;">
                                    ...
                                    <div id="FontSizeCity" class="text-sm-right">Sun Dist: {{$MoonDistanceSun}}*10<sup>5</sup> </div>
            ...
            <div class="col-md-12 col-xl-4 mt-3 px-2" style="border-left:1px solid gray;border-right:1px solid gray;">
                <div class="row">
                    <!-- Radio -->
                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 px-1">
                        <div class="col-md-12">
                            <select class="dropdown-select mt-2 pb-2" name="RadioStation" id="RadioStation" onchange="RadioValueGet()">
                        ...
                        <div class="col-md-12 mb-1 pt-1">
                            ...
                            <button class="material-icons btn-sm btn-dark" onclick="playVid()" data-toggle="tooltip" title="Play!">play_arrow</button>
                            <input id="vol-control" class="slider" type="range" min="0" max="100" step="1" oninput="SetVolume(this.value)" onchange="SetVolume(this.value)">
                            <button class="material-icons btn-sm btn-dark" data-toggle="tooltip" title="Details!">arrow_downward</button>
                        </div>
                    </div>
                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 px-1 mt-3">
            ...
            <div class="col-md-8 ">
                <div class="row">
                    ...
                    <div class="col-md-4 px-1 mt-2">
                        <div class="border bg-dark" id="height450">div</div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 ">
